    ...
    switch (item) {
      case "milk":
        if (dizi.members[i].resources.milk > 0) {
          ...
          dizi.members[i].resources.coin += fonk.sellMilk(sutMiktari);
        ...
        break;
      case "egg":
        if (dizi.members[i].resources.egg > 0) {
          var yumurtaMiktari = dizi.members[i].resources.egg;
          dizi.members[i].resources.coin += fonk.sellEgg(yumurtaMiktari);
        ...
        break;
      case "honey":
        if (dizi.members[i].resources.honey > 0) {
          var balMiktari = dizi.members[i].resources.honey;
          dizi.members[i].resources.coin += fonk.sellHoney(balMiktari);
